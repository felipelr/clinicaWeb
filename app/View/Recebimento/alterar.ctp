<div class="">
    <form id="RecebimentoAlterarForm" class="form-horizontal" method="post" action="<?php echo $this->Html->url(array("controller" => "recebimento", "action" => "alterar")); ?>">
        <input type="hidden" value="<?php echo $dadosRecebimento['idrecebimento']; ?>" name="data[Recebimento][idrecebimento]" />
        <div>
            <h3>Alterando Recebimento</h3>
            <hr/>
            <div class="row">
                <br/>         
                <div class="col-md-10">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-10">
                            <input value="<?php echo $dadosRecebimento['descricao']; ?>" autofocus="autofocus" id="RecebimentoDescricao" name="data[Recebimento][descricao]" data-required="true" placeholder="Digite a descrição" class="form-control" />
                        </div>                        
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="btn-group">
                    <a class="btn btn-default" href="<?php echo $this->Html->url(array("controller" => "recebimento", "action" => "gestao", $dadosRecebimento['idrecebimento'])); ?>">Voltar</a>
