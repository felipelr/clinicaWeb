                                ...
                                <select id="RecebimentoIdPlanoSessao" name="data[Recebimento][id_plano_sessao]" class="form-control combos validarChange" title="Plano Sessão">
                                    ...
                                    if ($total_pl > 0):
                                        for ($ip = 0; $ip < $total_pl; $ip++) :
                                            ?>
                                            <option value="<?php echo $PlanoSessoes[$ip]["p"]["idplanosessao"]; ?>" ><?php echo $PlanoSessoes[$ip]["p"]["descricao"]; ?></option>
                                            <?php
                                        endfor;
                                    endif;
                                    ?>
                            ...
                            <table id='tabela-eventos' class='table table-responsive table-bordered'>
                                ...
                                <tbody>
                                    <tr class="last-row" data-indice="0">
                                        ...
                                        <td>
                                            <input name="data[Recebimento][eventos][0][horario_inicio]" type="text" class="form-control input-hora-inicio"/>
                                        </td>
                                        <td>
                                            <input name="data[Recebimento][eventos][0][horario_termino]" type="text" class="form-control input-hora-termino"/>
                                        </td>
                                        <td class="center">
                                            <div>
...
<?php
echo $this->Html->css(array("datepicker.min.css", "select2/select2.min.css", "icheck/all.css", "fileinput.min.css", "jspanel/jquery-ui.min.css",
    "jspanel/jquery.jspanel.css"), null, array("block" => "css"));
echo $this->Html->script(array("jspanel/jquery-ui.min.js", "bootstrap-datepicker.min.js", "jquery.maskMoney.min.js", "jquery.maskedinput.min.js", "jquery-validate.min.js",
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $("#RecebimentoValor").maskMoney({symbol: "R$", decimal: ",", thousands: "."});

        jQuery(".validarChange").change(function () {
            jQuery("#btn-salvar").hide();
        });
        ...
        if (jQuery("#PlanoSessaoDescricao").val() !== "" && jQuery("#PlanoSessaoQuantidadeSessoes").val() !== "" && jQuery("#PlanoSessaoQuantidadeMeses").val() !== "") {
            ...
            jQuery.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    if (data !== null) {
                        var json = jQuery.parseJSON(data);
                        jQuery("<option value='" + json.idplanosessao + "'>" + json.descricao + "</option>").appendTo("#RecebimentoIdPlanoSessao");
