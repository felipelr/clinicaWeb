...
<div class="">
    <?php
    echo $this->Form->create('Despesa', array("url" => array("controller" => "despesa", "action" => "pre_cadastro"), "class" => "form-horizontal", "method" => "post", "enctype" => "multipart/form-data"));
    ?>    
    <div>
        <h3>Pré-Cadastro de Despesas</h3>
        <hr/>
        <div class="row">
            <br/>         
            <div class="col-md-10">
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery('#DespesaPreCadastroForm').validate({
            onKeyup: true,
