...
echo $this->Html->script(array("bootstrap-datepicker.min.js", "jquery.maskMoney.min.js", "jquery.maskedinput.min.js", "jquery-validate.min.js",
    "select2/select2.full.min.js", "icheck/icheck.min.js", "app.cadastro.favorecido.js?v=1.3"), array("block" => "script"));
?>
<div class="">
    <?php
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="form-group ">
                    ...
                    <div class="col-md-10">
                        <input autofocus="autofocus" id="FavorecidoNome" name="data[Favorecido][nome]" data-required="true" placeholder="Digite o nome" class="form-control" />
                    </div>                        
                </div>
                <div class="form-group ">
                ...
                <div id="div_resumido" style="display: none;">
                    <div class="form-group">
                        <label for="FavorecidoContato" class="control-label col-md-2">Contato:</label>
                        <div class="col-md-10">
                            <input id="FavorecidoContato" name="data[Favorecido][contato]"  placeholder="Digite o contato" class="form-control" />
                        </div>                        
                    </div>
                    <div class="form-group ">
                        <label for="FavorecidoTelefone" class="control-label col-md-2">Telefone:</label>
                        <div class="col-md-10">
                            <input id="FavorecidoTelefone" name="data[Favorecido][telefone]"  placeholder="(99) 9999-9999" class="form-control" />
                        </div>                        
                    </div>
                    <div class="form-group">
                        <label for="FavorecidoEmail" class="control-label col-md-2">Email:</label>
                        <div class="col-md-10">
                            <input id="FavorecidoEmail" name="data[Favorecido][email]" data-validate="emaill"  type="email"  placeholder="Digite o e-mail" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input id="EnderecoNumero" name="data[Endereco][numero]" data-validate="numeroo"  placeholder="Digite o número" class="form-control" />                                  
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-10">
                            <input id="FavorecidoObservacao" name="data[Favorecido][observacao]" class="form-control" />
                        </div>                        
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            $('.div-radios').on('ifChecked', function(event) {
                $('#div_resumido').toggle($(".div-radios").eq(1).is(':checked'));
            });
        });
    </script>
</div>