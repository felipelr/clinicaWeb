...
<div class="">
    <?php
    echo $this->Form->create('Caixa', array("url" => array("controller" => "caixa", "action" => "alterar"), "class" => "form-horizontal", "method" => "post", "enctype" => "multipart/form-data"));
    ?>   
    <div>
        ...
        <div id="tab-1" class="tab col-md-12 col-xs-12">
            ...
            <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <div class="col-md-8">
                        <input value="<?php echo $Caixa['descricao'] ?>" autofocus="autofocus" id="CaixaDescricao" name="data[Caixa][descricao]" data-required="true" placeholder="Digite a descrição do caixa" class="form-control" />
                    </div>                        
                </div> 
                <div class="form-group ">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-8 div-radios" style="padding-top: 5px">    
                        <input name="data[Caixa][tipo]" type="radio" value="COFRE" id="CaixaTipoCofre" <?php echo ($Caixa['tipo'] == 'COFRE') ? 'checked' : ''; ?> />
                        <label for="CaixaTipoCofre">Cofre</label>   
                        &nbsp;&nbsp;              
                        <input name="data[Caixa][tipo]" type="radio" value="CONTA" id="CaixaTipoConta" <?php echo ($Caixa['tipo'] == 'CONTA') ? 'checked' : ''; ?> />
                        <label for="CaixaTipoConta">Conta Bancária</label>
                        &nbsp;&nbsp;
                        <input name="data[Caixa][tipo]" type="radio" value="DIARIO" id="CaixaTipoDiario" <?php echo ($Caixa['tipo'] == 'DIARIO') ? 'checked' : ''; ?> />
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            jQuery('#CaixaAlterarForm').validate({
                onKeyup: true,
