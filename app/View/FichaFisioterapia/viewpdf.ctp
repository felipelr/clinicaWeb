<div>
    ...
    <!-- Tab panes -->
    <form id="form-cadastrar-ficha" class="form-horizontal" method="post" action="<?php echo $this->Html->url(array("controller" => "ficha_fisioterapia", "action" => "alterar")); ?>">
        <input type="hidden" name="FichaFisioterapia[idfichafisioterapia]" id="IdFicha" value="<?php echo $FichaFisioterapia['idfichafisioterapia']; ?>"/>
        <input type="hidden" name="FichaFisioterapia[id_paciente]" id="IdPacienteFicha" value="<?php echo $FichaFisioterapia['id_paciente']; ?>"/>
        <input type="hidden" name="FichaFisioterapia[descricao]" id="DescricaoFicha" value="<?php echo $FichaFisioterapia['descricao']; ?>"/>
            ...
            <div role="tabpanel" class="tab-pane fade in active" id="tab1">
                <div class="col-sm-10 col-sm-offset-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="FichaFisioterapia[nome_paciente]" type="text" required disabled value="<?php echo $FichaFisioterapia['nome_paciente']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="FichaFisioterapia[sobrenome_paciente]" type="text" required disabled value="<?php echo $FichaFisioterapia['sobrenome_paciente']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="FichaFisioterapia[data_nascimento_paciente]" type="text" required disabled value="<?php echo $FichaFisioterapia['data_nascimento_paciente']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group div-radios">
                        ...
                        <div class="col-sm-10">
                            <input name="FichaFisioterapia[sexo_paciente]" type="radio" value="M" id="PacienteSexoM" <?php echo $FichaFisioterapia['sexo_paciente'] == 'M' ? 'checked' : 'disabled'; ?>/>
                            <label class="label-radio" for="PacienteSexoM">Masculino</label>
                            <input name="FichaFisioterapia[sexo_paciente]" type="radio" value="F" id="PacienteSexoF" <?php echo $FichaFisioterapia['sexo_paciente'] == 'F' ? 'checked' : 'disabled'; ?>/>
                    ...
                    <div class="form-group div-radios">
                        ...
                        <div class="col-sm-10">
                            <input name="FichaFisioterapia[estado_civil_paciente]" type="radio" value="Solteiro" id="PacienteEstadoCivilSolteiro" <?php echo $FichaFisioterapia['estado_civil_paciente'] == 'Solteiro' ? 'checked' : 'disabled'; ?>/>
                            <label class="label-radio" for="PacienteEstadoCivilSolteiro">Solteiro</label>
                            <input name="FichaFisioterapia[estado_civil_paciente]" type="radio" value="Casado" id="PacienteEstadoCivilCasado" <?php echo $FichaFisioterapia['estado_civil_paciente'] == 'Casado' ? 'checked' : 'disabled'; ?> />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="FichaFisioterapia[naturalidade_paciente]" type="text" required value="<?php echo $FichaFisioterapia['naturalidade_paciente']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="FichaFisioterapia[local_nascimento_paciente]" type="text" required value="<?php echo $FichaFisioterapia['local_nascimento_paciente']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="FichaFisioterapia[profissao_paciente]" type="text" required value="<?php echo $FichaFisioterapia['profissao_paciente']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="FichaFisioterapia[endereco_residencial_paciente]" type="text" required value="<?php echo $FichaFisioterapia['endereco_residencial_paciente']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" name="FichaFisioterapia[endereco_comercial_paciente]" type="text" required value="<?php echo $FichaFisioterapia['endereco_comercial_paciente']; ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="btn-group pull-right">
                            <a class="btn btn-danger" href="<?php echo $this->Html->url(array("controller" => "ficha_fisioterapia", "action" => "prontuario")); ?>/<?php echo $FichaFisioterapia['id_paciente']; ?>"><i class="fa fa-times"></i> Cancelar</a>
                    ...
                    <div class="panel-group" id="accordion3" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel">
                            ...
                            <div id="collapse33" class="panel-collapse collapse" role="tabpanel" >
                                <input type="number" min="0" value="<?php echo $FichaFisioterapia['quantitativo_provavel']; ?>" name="FichaFisioterapia[quantitativo_provavel]" class="form-control"/>
                            </div>
                        </div>
                    </div>                                              
                    <div>
                            ...
                            <select id="IdProfissional" name="FichaFisioterapia[id_profissional]" class="form-control" title="Profissional" required>
                                ...
                                if ($total_ > 0):
                                    for ($i_ = 0; $i_ < $total_; $i_++) :
                                        ?>
                                        <option value="<?php echo $Profissionais[$i_]["p"]["idprofissional"]; ?>" <?php echo $FichaFisioterapia['id_profissional'] == $Profissionais[$i_]["p"]["idprofissional"] ? "selected" : ""; ?>>
                                            <?php echo $Profissionais[$i_]["p"]["nome"] . " " . $Profissionais[$i_]["p"]["sobrenome"]; ?>
                                        </option>
                                        <?php
                                    endfor;
                                endif;
