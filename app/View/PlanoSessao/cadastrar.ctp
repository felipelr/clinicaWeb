                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-10 div-radios" style="padding-top: 5px">
                        <label for="PlanoSessaoTipoQuantidadeSessoesDeterminar">
                            <input name="data[PlanoSessao][tipo_quantidade_sessoes]" type="radio" value="DETERMINAR" id="PlanoSessaoTipoQuantidadeSessoesDeterminar" checked />
                            Determinar quantidade de sessões
                        </label>
                        &nbsp;&nbsp;
                        <label for="PlanoSessaoTipoQuantidadeSessoesMax">
                            <input name="data[PlanoSessao][tipo_quantidade_sessoes]" type="radio" value="MAX" id="PlanoSessaoTipoQuantidadeSessoesMax" />
                            Máximo de sessões dentro do período
                        </label>
                    </div>
                </div>

                <div id="PainelPlanoSessaoQuantidadeSessoes">
                    <div class="form-group">
