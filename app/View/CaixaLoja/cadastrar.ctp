...
<div class="">
    <?php
    echo $this->Form->create('CaixaLoja', array("url" => array("controller" => "caixa_loja", "action" => "cadastrar"), "class" => "form-horizontal", "method" => "post", "enctype" => "multipart/form-data"));
    ?>    
    <div>
        ...
        <div id="tab-1" class="tab col-md-12 col-xs-12">
            ...
            <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <div class="col-md-8">
                        <input autofocus="autofocus"  id="CaixaNome" name="data[Caixa][nome_caixa]" data-required="true" placeholder="Digite o nome" class="form-control" />
                    </div>                        
                </div>
                <div class="form-group ">
                        ...
                        <select id="Usuarios" name="data[Caixa][id_usuario]" data-required="true" class="form-control" title="Usuario">
                            ...
                            if ($total_ > 0):
                                for ($i_ = 0; $i_ < $total_; $i_++) :
                                    ?>
                                    <option value="<?php echo $Usuarios[$i_]["u"]["idusuario"]; ?>" ><?php echo $Usuarios[$i_]["u"]["nome"] . " " . $Usuarios[$i_]["u"]["sobrenome"]; ?></option>
                                    <?php
                                endfor;
                            endif;
                            ?>
