<div class="">
    ...
    <div class="well">
        <form id="form-consultar" class="form-inline" data-action="<?php echo $this->Html->url(array("controller" => "relatorio", "action" => "ajax_relatorio_cheque")); ?>" method="post">
            ...
            <div class="row-divisao">                
                <div class="form-group">
                    <label class="control-label" style="width: 92px;">Núm. Cheque:</label>                
                </div>
                <div class="form-group" style="margin-right: 15px;">
                    <input name="numero_cheque" class="form-control" value="<?php echo $numero_cheque; ?>"/>                 
                </div>
                <div class="form-group">
                    <label class="control-label" style="width: 100px;">Compensado?</label>                
                </div>
                <div class="form-group">
                    <select id="compensado" class="form-control" name="compensado">
                        <option value="0" <?php echo $compensado_ == 0 ? "selected" : ""; ?> >Não</option>
                        <option value="1" <?php echo $compensado_ == 1 ? "selected" : ""; ?> >Sim</option>
                    </select>                   
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function receber_cheque(idfinanceiro) {
        if (!carregando) {
            jQuery.ajax({
                url: $NOME_APLICACAO + "/relatorio/compensar_cheque?idfinanceiro=" + idfinanceiro,
                type: 'POST',
