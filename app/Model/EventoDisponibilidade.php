...
class EventoDisponibilidade extends AppModel
{
    ...
    public function retornarPorIdRecebimento($idrecebimento, $idpaciente)
    {
        ...
        return isset($dados[0]) ? $dados[0]["evento_disponibilidade"] : null;
    }
    ...
    public function updateTotal($ideventodisponibilidade, $total)
    {
        ...
        $this->query("update evento_disponibilidade set total = $total, total_sessoes = total_sessoes + $total where ideventodisponibilidade = $ideventodisponibilidade;");
    }
}
