jQuery(function () {
    ...
    if (jQuery("#foto").attr('data-type') !== 'none') {
        jQuery("#foto").fileinput({
            initialPreview: [
                "<img src='data:" + $('#foto').attr('data-type') + ";base64, " + $('#foto').attr('data-string') + "' class='file-preview-image' alt='' title=''>"
            ],
    ...
    jQuery("#PacienteCep").mask("99999-999");
    jQuery("#PacienteDataInicioAtendimento").mask("99/99/9999");

    jQuery('#PacienteAlterarForm').validate({
        onKeyup: true,
...
function changeMaiorIdade() {
    if (jQuery("#div-nomeresp1,#div-nomeresp2").hasClass("active")) {
        jQuery("#div-nomeresp1,#div-nomeresp2").removeClass("active");
